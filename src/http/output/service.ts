...
export class ServiceGenerator {
  ...
  constructor(baseDir: string, project: Project, httpAdapter: IHttpAdapter, savedFilePath: any[]) {
    ...
    if (fs.existsSync(fileSavePath)) {
      // 删除非本次生成的已存在文件
      if (!savedFilePath.includes(fileSavePath)) {
  ...
  generate(projectImportClassPath: string[], requestStr: string) {
    ...
    // 增加注释
    this.sourceFile.insertStatements(0, '// 此文件由 oneapi-cli 自动生成，请不要编辑（This file is auto-generated by oneapi-cli, Please do not edit it）');
